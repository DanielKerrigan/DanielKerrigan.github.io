...
<section id="parallel">
	<h3>Reducing Edge Crossings in Parallel Coordinates</h3>
	<p>
		For my algorithms course at NYU, I created an <a href="https://dankerrigan.me/algs-2-project/"
			>interactive article</a
		> that explains how edge crossings can be reduced in parallel coordinates plots.
	</p>
</section>

<section id="tracelink">
	<h3>Traceability Visualization</h3>
	<p>
		...
		and clicking on the nodes. It might take some time for the data to load for this visualization.
	</p>
</section>
...
<section id="nutrition">
	...
	<p>
		<a rel="external" href="https://dankerrigan.me/bytes-of-nutrition">Bytes of Nutrition</a> was my
		...
		accepted to IEEE VIS 2017. If you are interested in the final version, look at the
		<a rel="external" href="/papers/poster.pdf">poster</a>, watch the
		<a href="https://vimeo.com/230838162">demo video</a>
		and read the <a rel="external" href="/papers/NutritionBytesFinal.pdf">extended abstract</a>.
	</p>
</section>
